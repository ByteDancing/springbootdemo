                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="alert alert-block alert-success">
                            ...
                            一个简单的、多功能的和简单的模板,可以在 bootstrap 3.3.6. З上使用，下载源地址在 <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css files).
                        </div>
                                            ...
                                            <div class="tab-content padding-8">
                                                ...
                                                <div id="member-tab" class="tab-pane">
                                                    <div class="clearfix">
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar" src="../images/avatars/user.jpg" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar" src="../images/avatars/avatar1.png" />
                                                            </div>
                                                ...
                                                <div id="comment-tab" class="tab-pane">
                                                    <div class="comments">
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Jennifer's Avatar" src="../images/avatars/avatar1.png" />
                                                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main no-padding">
                                            <div class="dialogs">
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    <div class="user">
                                                        <img alt="Bob's Avatar" src="../images/avatars/user.jpg" />
                                                    </div>
